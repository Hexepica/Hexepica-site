...
export const animateMethodology = (element) => {
...
export const animateAbout = (element) => {
    const title = element.querySelector('.bg-title');
    const description = element.querySelector('.header-description');
...
export const animateServices = (element) => {
    const title = element.querySelector('.bg-title');
    const description = element.querySelector('.header-description');
...
export const animateBlog = (element) => {
    const title = element.querySelector('.bg-title');
    const description = element.querySelector('.header-description');
...
export const animateContact = (element) => {
    const title = element.querySelector('.bg-title');
    const description = element.querySelector('.header-description');
...
// Footer animations
export const animateFooter = (element) => {
